...
public class RedClose12GateOnce extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Command intakeAndShootPPG = new SequentialCommand(
                autoCommands.driveAndIntakeBallsBounce(BallPose.PPG, close, red, new Pose(-1, 2, Math.toRadians(1))),
        ...
        Command intakeAndShootPGP = new SequentialCommand(
                autoCommands.driveAndIntakeBallsBounce(BallPose.PGP, close, red, new Pose(0, 1, Math.toRadians(-4))),
                autoCommands.goAndShootBalls(BallPose.PGP, close, red, RobotConstants.Auto.GatePose.NONE, new Pose(-3, 2, Math.toRadians(0)))
        );

        Command intakeAndShootGPP = new SequentialCommand(
                autoCommands.driveAndIntakeBallsBounce(BallPose.GPP, close, red, new Pose(0, 2, Math.toRadians(-2))),
