...
public class InterpolationPoints {
    ...
    public static ArrayList<Point> points_11_30 = new ArrayList<>(Arrays.asList(
            new Point(1.67, 165),
            new Point(1.82, 160),
            new Point(2.14, 160),
            new Point(2.33, 160),
    ...
    public static ArrayList<Point> points_1_4 = new ArrayList<>(Arrays.asList(
            new Point(1.46, 160),
            new Point(1.62, 167),
            new Point(1.8, 155),
            new Point(2.1, 150),
...
//            new Point(125, 1)
    ...
    public static ArrayList<Point> rpms_5_11 = new ArrayList<>(Arrays.asList(
            new Point(78, 115),
            new Point(90.8, 120),
            new Point(104, 120),
            new Point(110, 123),
