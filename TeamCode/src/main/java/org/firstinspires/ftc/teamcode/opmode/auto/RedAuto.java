...
public class RedAuto extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Command command = new SequentialCommand(
                ...
                delay,
                intakeToShootTrajectory(drivetrain, BallPose.GPP, close, red, telemetry),
                delay,
                shootToIntakeTrajectory(drivetrain, BallPose.PGP, close, red, telemetry),
                delay,
                intakeToShootTrajectory(drivetrain, BallPose.PGP, close, red, telemetry),
                delay,
                shootToIntakeTrajectory(drivetrain, BallPose.PPG, close, red, telemetry),
                delay,
                intakeToShootTrajectory(drivetrain, BallPose.PPG, close, red, telemetry),
                delay
        );
